 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class P4CMS_Sniffs_Commenting_FunctionCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        // P4CMS: skip anonymous functions (where no function name is used)
        if ($phpcsFile->isAnonymousFunction($stackPtr)) {
            return;
        }
        ...
        // P4CMS: disable processing returns
    ...
    protected function processReturn($commentStart, $commentEnd)
    {
        ...
        if ($isSpecialMethod === false && $methodName !== $className) {
            ...
            if ($this->commentParser->getReturn() === null) {
                ...
                #$tokens = $phpcsFile->getTokens();
                #$content = $phpcsFile->getTokensAsString($commentEnd, 10);
                #print "content1: ". $tokens[$commentEnd]['content'] ."\n";
                #print "content2: ". $content ."\n";
                $error = 'Missing @return tag in function <'. $this->_methodName .'> comment';
