...
class P4CMS_Sniffs_Commenting_FileCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    {
        $docBlock    = (get_class($this) === 'P4CMS_Sniffs_Commenting_FileCommentSniff') ? 'file' : 'class';
...
/* P4CMS: disable this block of sniffs
