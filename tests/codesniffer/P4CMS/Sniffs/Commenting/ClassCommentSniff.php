...
// P4CMS: work-around to ensure file is sourced properly
...
if (class_exists('P4CMS_Sniffs_Commenting_FileCommentSniff', true) === false) {
    $error = 'Class P4CMS_Sniffs_Commenting_FileCommentSniff not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class P4CMS_Sniffs_Commenting_ClassCommentSniff extends P4CMS_Sniffs_Commenting_FileCommentSniff
{
