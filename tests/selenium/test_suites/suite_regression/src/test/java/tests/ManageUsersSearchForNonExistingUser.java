...
public class ManageUsersSearchForNonExistingUser extends shared.BaseTest  {
	
	private String baseurl;
	private String redirecturl;
	private String usergroup;
	private String quart_scriptname = "ManageUsersSearchForNonExistingUser";
	...
	@Test(dataProvider = "Users")
 	public void validate(String username, String password)
		...
		// User management
		ManageUsersSearchForNonExistingUser();
...
public void ManageUsersSearchForNonExistingUser() throws Exception {
		...
		// search for user
		selenium.type("id=search-query", "foo");
		Thread.sleep(1000);
		
		//writeFile1("\nskipped 1401", "", "ManageUsersAddUser.java");
		// check to see if user selected is checked and write to file
		
		String quart_detailid   = "1195";
		 String  quart_testname   = "SearchForNonExistingUser";
		 String  quart_description= "verify search for non existing user";
