...
public class ManageUsersCreateEditorUser extends shared.BaseTest  {
	
	private String baseurl;
	private String redirecturl;
	private String usergroup;
	private String quart_scriptname = "ManageUsersCreateEditorUser";
...
public void ManageUsersCreateEditorUser() throws Exception {
		...
		String testUser = "curly";
		// form for add user
		selenium.type("id=id", testUser);
		selenium.type("id=email", "curly-user@perforce.com");
		selenium.type("id=fullName", "CurlyUser");
		...
		selenium.click("id=role-roles-editor");
		Thread.sleep(1000);
		
		//writeFile1("\nskipped 1401", "", "ManageUsersAddUser.java");
		// check to see if user selected is checked and write to file
		 String quart_detailid   = "1200";
		 String  quart_testname   = "CreateEditorUser";
		 String  quart_description= "verify create curly user editor role";
			if(selenium.isTextPresent( "curly"))
