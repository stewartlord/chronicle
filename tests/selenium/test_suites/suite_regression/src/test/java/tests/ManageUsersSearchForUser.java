...
public class ManageUsersSearchForUser extends shared.BaseTest  {
	
	private String baseurl;
	private String redirecturl;
	private String usergroup;
	private String quart_scriptname = "ManageUsersSearchForUser";
...
public void ManageUsersSearchForUser() throws Exception {
		...
		String testUser = "larry";
		// form for add user
		selenium.type("id=id", testUser);
		selenium.type("id=email", "larry-user@perforce.com");
		selenium.type("id=fullName", "LarryUser");
		...
		// search for user
		selenium.type("id=search-query", "larry");
		Thread.sleep(1000);
		
		//writeFile1("\nskipped 1401", "", "ManageUsersAddUser.java");
		// check to see if user selected is checked and write to file
		String quart_detailid   = "1196";
		 String  quart_testname   = "SearchForUser";
		 String  quart_description= "verify create and search for user";
			if(selenium.isTextPresent( "larry"))
