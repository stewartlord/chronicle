...
public class EditPressReleaseAllElementsVerify extends shared.BaseTest  {
	
	private String baseurl;
	private String redirecturl;
	private String usergroup;
	private String quart_scriptname = "EditPressReleaseAllElementsVerify";
	...
	@Test(dataProvider = "Users")
 	public void validate(String username, String password)
		...
		EditPressReleaseAllElementsVerify();
	...
	public void EditPressReleaseAllElementsVerify() throws InterruptedException, Exception {
	
		// add press release, save, and click edit
		verifyContentElements();
		editPressRelease();
	
		 String quart_detailid   = "8093";
		...
		if (selenium.isElementPresent(("//span[contains(@id, 'edit-content-toolbar-button-Categories_label')]")))
		  ...
		  quart_description= "place mode delete verify";
		...
		quart_detailid   = "8091";
		 quart_testname   = "PlaceModeEditPressReleasePlaceModeDateVerify";
		...
		quart_detailid   = "8090";
		  ...
		  quart_description= "place mode subtitle verify";
		// verify place mode workflow
		  if (selenium.isElementPresent(("//h2[contains(@class, 'content-element content-element-type-text content-element-subtitle')]")))
			  writeFile(quart_detailid, "pass", quart_scriptname, quart_testname, quart_description); 
	        else  { writeFile(quart_detailid, "fail", quart_scriptname, quart_testname, quart_description); }
		  ...
		  quart_description= "place mode location verify";
			if (selenium.isElementPresent(("//div[contains(@class, 'content-element content-element-type-text content-element-location')]")))
				writeFile(quart_detailid, "pass", quart_scriptname, quart_testname, quart_description); 
	        else  { writeFile(quart_detailid, "fail", quart_scriptname, quart_testname, quart_description); }
			  ...
			  quart_description= "place mode contact details verify";
			  if (selenium.isElementPresent(("//div[contains(@class, 'content-element content-element-type-editor content-element-contact')]")))
					writeFile(quart_detailid, "pass", quart_scriptname, quart_testname, quart_description); 
		        else  { writeFile(quart_detailid, "fail", quart_scriptname, quart_testname, quart_description); }
	...
	//**** Click into form mode ****//
		...
		if (selenium.isTextPresent(("Workflow")))
		  ...
		  quart_detailid   = "8058";
		  quart_testname   = "FormModeElementVerify";
		  quart_description= "form mode element verify";
		...
		if (selenium.isTextPresent("Title"))
		 ...
		 quart_description= "form mode sub title verify ";
		// verify place mode workflow
		...
		quart_detailid   = "8065";
		  ...
		  quart_description= "form mode location verify";
		// verify in location button
		if (selenium.isElementPresent(("//input[contains(@id, 'location')]")))
			  writeFile(quart_detailid, "pass", quart_scriptname, quart_testname, quart_description); 
        else  { writeFile(quart_detailid, "fail", quart_scriptname, quart_testname, quart_description); }

		
		quart_detailid   = "8067";
		  quart_testname   = "FormModeContactDetailsVerify";
		  quart_description= "form mode contact details verify";
		// verify in form button
		if (selenium.isElementPresent(("//div[contains(@id, 'contact-Editor')]")))
		  ...
		  quart_description= "form mode button verify";
		  if (selenium.isElementPresent(("//span[contains(@id, 'edit-content-toolbar-button-in-place_label')]")))
			  writeFile(quart_detailid, "pass", quart_scriptname, quart_testname, quart_description); 
	        else  { writeFile(quart_detailid, "fail", quart_scriptname, quart_testname, quart_description); }
