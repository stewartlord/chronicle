...
public class ManageUsersCreateDuplicateUser extends shared.BaseTest  {
	
	private String baseurl;
	private String redirecturl;
	private String usergroup;
	private String quart_scriptname = "ManageUsersCreateDuplicateUser";
	...
	@Test(dataProvider = "Users")
 	public void validate(String username, String password)
		...
		// User management
		ManageUsersCreateDuplicateUser();
...
public void ManageUsersCreateDuplicateUser() throws Exception {
		...
		String testUser = "chronicle-test";
		// form for add user
		...
		// check to see if user selected is checked and write to file
		 ...
		 String quart_detailid   = "7716";
		 String  quart_testname   = "CreateDuplicateUser";
		 String  quart_description= "verify duplicate user message";
			if(selenium.isTextPresent( "User" + testUser + "already exists"))
