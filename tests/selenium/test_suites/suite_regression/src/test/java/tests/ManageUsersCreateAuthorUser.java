...
public class ManageUsersCreateAuthorUser extends shared.BaseTest  {
	
	private String baseurl;
	private String redirecturl;
	private String usergroup;
	private String quart_scriptname = "ManageUsersCreateAuthorUser";
...
public void ManageUsersCreateAuthorUser() throws Exception {
		...
		String testUser = "steve";
		// form for add user
		selenium.type("id=id", testUser);
		selenium.type("id=email", "steve-user@perforce.com");
		selenium.type("id=fullName", "SteveUser");
		selenium.type("id=password", "testing!612");
		selenium.type("id=passwordConfirm", "testing!612");
		selenium.click("id=roles-author");
		selenium.click("id=save_label");
		Thread.sleep(2000);
		
		// click on author checkbox
		selenium.click("id=role-roles-author");
		Thread.sleep(1000);
		...
		// check to see if user selected is checked and write to file
		 ...
		 String quart_detailid   = "1199";
		 String  quart_testname   = "CreateAuthorUser";
		 String  quart_description= "verify create steve user author role";
			if(selenium.isTextPresent( "steve"))
