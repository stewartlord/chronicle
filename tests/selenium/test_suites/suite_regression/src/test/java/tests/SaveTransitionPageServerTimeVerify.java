...
public class SaveTransitionPageServerTimeVerify extends shared.BaseTest  {
	
	private String baseurl;
	private String redirecturl;
	private String usergroup;
	private String quart_scriptname = "SaveTransitionBasicPageServerTimeVerify";
	...
	@Test(dataProvider = "Users")
 	public void validate(String username, String password)
		...
		SaveTransitionPageServerTimeVerify();
				
		// Logout and verify Login link
		selenium.click("link=Logout");
	}
	
	public void SaveTransitionPageServerTimeVerify() throws InterruptedException, Exception {
		...
		String quart_detailid   = "8433";
		String quart_testname   = "BasicPageServerTimeVerify";
		String quart_description= "verify Save basic page server time";
