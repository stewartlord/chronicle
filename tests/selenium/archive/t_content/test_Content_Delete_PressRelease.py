...
class test_Content_Delete_PressRelease(unittest.TestCase):
    def setUp(self):
        self.verificationErrors = []
        self.selenium = selenium(connection["host"], connection["port"], connection["browser"], connection["url"])
        self.selenium.start()

    def test_content_delete_pressrelease(self):
        sel = self.selenium
        sel.open("/")
        sel.click("link=Press Release IPM")
        ...
        try: 
           ...
           functions.printResults("6538","pass")
        except AssertionError, e:
           self.verificationErrors.append(str(e))
           functions.printResults("6538","fail")
        try: 
           self.failIf(sel.is_text_present("Press Release IPM"))
           functions.printResults("6538","pass")
        except AssertionError, e:
           self.verificationErrors.append(str(e))
           functions.printResults("6538","fail")
