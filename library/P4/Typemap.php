 ...
 */
class P4_Typemap extends P4_SpecAbstract
{
     ...
     * @return  P4_Typemap  provides a fluent interface.
     */
     ...
     */
    protected function _toTypemapArray($entry)
    {
     ...
     */
    protected function _fromTypemapArray($array)
    {
     ...
     */
    protected function _isValidTypemapArray($array)
    {
        if (!is_array($array)) {
            return false;
        }
