 ...
 * of P4_Iterator class then $iterator->next()
 ...
 */
class P4_Iterator extends ArrayIterator
{
     ...
     */
    protected $_allowedModelClass = 'P4_ConnectedInterface';
     ...
     * @param P4_Model          $model  the model to store.
     * @return void
     */
     ...
     * @return  P4Cms_Model_Iterator    provides fluent interface
     */
     ...
     *
     * @param   P4_Iterator     $iterator   The new values to merge in
     * @return  P4_Model_Iterator           provides fluent interface
     */
    public function merge(P4_Iterator $iterator)
    {
     ...
     * @return  P4_Iterator     provides a fluent interface
     */
