 ...
 */
class P4_Triggers extends P4_SpecAbstract
{
    protected static $_specType  = 'triggers';
     ...
     * @return  P4_Triggers       provides a fluent interface.
     */
     ...
     */
    protected function _toTriggerArray($entry)
    {
     ...
     */
    protected function _fromTriggerArray($array)
    {
     ...
     */
    protected function _isValidTriggerArray($array)
    {
        if (!is_array($array)) {
            return false;
        }
