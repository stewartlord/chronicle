...
class P4_File_Query
{
    ...
    protected $_validFieldNames         = null;
     ...
     * the filter format. Accepts a P4_File_Filter or string for input,
     * or null to remove any filter.
     *
     * @param   string|P4_File_Filter|null $filter  The desired filter.
     * @return  P4_File_Query  provide a fluent interface.
     */
     ...
     */
    protected function _isValidSortField($field)
    {
     ...
     */
    protected function _isInternalSortField($field)
    {
     ...
     */
    protected function _isValidSortOptions($options)
    {
