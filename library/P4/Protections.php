 ...
 */
class P4_Protections extends P4_SpecAbstract
{
    protected static    $_specType  = 'protect';
     ...
     * @return  P4_Protections  provides a fluent interface.
     */
     ...
     */
    protected function _toProtectArray($entry)
    {
