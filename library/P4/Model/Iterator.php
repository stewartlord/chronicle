 ...
 * of P4_Model_Iterator class then $iterator->next()
 ...
 */
class P4_Model_Iterator extends P4_Iterator
{
     ...
     */
    protected $_allowedModelClass = 'P4_ModelInterface';
     ...
     * @return  P4_Model_Iterator   provides fluent interface.
     */
     ...
     *
     * @param   P4Cms_Model     $model      the model to test against filter.
     * @param   string|array    $fields     one or more fields to check for acceptable values.
     * @param   string|array    $values     one or more acceptable values/patterns
     * @param   string|array    $options    optional - one or more filtering options
     * @return  bool            true if the model passes filter; false otherwise.
     */
    protected function _passesFilter($model, $fields, $values, $options)
    {
     ...
     */
    protected function _valueMatches($value, $filter, $options)
    {
     ...
     */
    protected function _getSortComparator($options)
    {
     ...
     */
    protected function _normalizeSortOptions(array $options)
    {
     ...
     */
    protected function _getValidSortOptions()
    {
        return array(
            static::SORT_ALPHA,
